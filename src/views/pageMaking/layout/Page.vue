...
// 基础组件 配置
import BaseTools from '../items/baseTools';
// 小组件
import ToolsSwitch from '../items/tools/Switch';
import ToolsSlider from '../items/tools/Slider';
import ToolsInputNumber from '../items/tools/InputNumber';
import ToolsLoops from '../items/tools/Loops';
import ToolsPanel from '../items/tools/Panel';
import ToolsLayout from '../items/tools/Layout';
